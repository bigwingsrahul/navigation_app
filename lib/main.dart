...
void _initializeHERESDK() async {
  ...
  String accessKeyId = "YOUR_ACCESS_KEY_HERE";
  String accessKeySecret = "YOUR_ACCESS_KEY_SECRET_HERE";
...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void _onMapCreated(HereMapController hereMapController) {
    ...
    hereMapController.mapScene.loadSceneForMapScheme(MapScheme.normalDay, (MapError? error) async {
      ...
      if (error == null) {
        ...
        _appLogic = AppLogic(hereMapController, _updateMessageState, _updateRouteState, _showDialog);
  ...
  void _updateRouteState(RouteStateModel value) {
    if (_appLogic != null) {
      _appLogic.reRoute(context, value);
    }
  }
