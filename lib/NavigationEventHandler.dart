...
import 'package:navigation_app/AppLogic.dart';

import 'LanguageCodeConverter.dart';
import 'RouteStateModel.dart';
...
class NavigationEventHandler {
  ...
  NavigationEventHandler(
      ...
      ValueChanged<RouteStateModel> updateRouteState,
  ...
  void setupListeners() {
    ...
    _visualNavigator.routeDeviationListener =
      ...
      _updateRouteState(RouteStateModel(route, newStartingPoint, routeDeviation.lastTraveledSectionIndex, routeDeviation.traveledDistanceOnLastSectionInMeters));
