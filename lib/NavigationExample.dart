...
class NavigationExample {
  ...
  NavigationExample(HereMapController hereMapController, ValueChanged<String> updateMessageState, ValueChanged<RouteStateModel> updateRouteState)
    ...
    _navigationEventHandler = NavigationEventHandler(_visualNavigator, _updateRouteState, _dynamicRoutingEngine, _updateMessageState);
  ...
  void reRouteTruck(HERE.Route route) {
    _herePositioningProvider.stop();
    _visualNavigator.route = route;
    _herePositioningProvider.startLocating(_visualNavigator, LocationAccuracy.navigation);
  }
