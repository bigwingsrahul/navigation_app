...
class RouteCalculator {
  ...
  void reRouteTruck(Route route, Waypoint startingPoint, int lastTraveledSectionIndex, int traveledDistanceOnLastSectionInMeters, CalculateRouteCallback callback) {
    _routingEngine.returnToRouteWithTraveledDistance(route, startingPoint, lastTraveledSectionIndex, traveledDistanceOnLastSectionInMeters, callback);
  }
}
